...
export default function Footer() {
  return (
    <footer className="section-bg py-12 border-t border-slate-700">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          >
            <div className="text-2xl font-bold gradient-text mb-2">Manish Cheepa</div>
            <p className="text-slate-400">Software Developer IV • Data Engineering Specialist</p>
          </motion.div>
        ...
        >
          <p>&copy; 2024 Manish Cheepa. All rights reserved. Built with modern web technologies.</p>
        </motion.div>
      </div>
    </footer>
  );
